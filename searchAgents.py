...
def foodHeuristic(state, problem):
    ...
    "*** YOUR CODE HERE ***"
    # 5/4 - expanded nodes: 4137
    foodList = foodGrid.asList()
    if problem.isGoalState(state):
        return 0

    # from util import manhattanDistance # 3/4
    distance = []
    for plate in foodList:
        distance.append(mazeDistance(position, plate, problem.startingGameState))
        # distance.append(manhattanDistance(position, plate)) # 3/4
    ...
    #     return 0
    #
    # # distance = manhattanHeuristic(position, foodList[0])
    # distance = []
    # # from util import manhattanDistance
    # for plate in foodList:
    #     # tmp = manhattanHeuristic(position, plate)
    #     # if tmp < distance :
    #     #     distance = tmp
    #     distance.append(mazeDistance(plate, position, problem.startingGameState))
    #
